...
const AddAlbumDialog = () => {
  ...
  // Handles image file selection and updates the state
  ...
  //  Handles form submission to create a new album
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Album created successfully"); // Success notification
    } catch (error: any) {
      // Error handling
